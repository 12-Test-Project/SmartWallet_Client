        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-sm/6 font-semibold text-gray-400 hover:text-yellow-500 transition-all">
                  Inicio
                </Link>
              </li>
              <li>
                <Link to="/transactions" className="text-sm/6 font-semibold text-gray-400 hover:text-yellow-500 transition-all">
                  Transacciones
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm/6 font-semibold text-gray-400 hover:text-yellow-500 transition-all">
                  Acerca De
                </Link>
              </li>
            </ul>
