...
const Income = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ amount: '', timeLapse: '', current: true, userId: user.id })
      setShowForm(false)
      fetchIncome()
    } catch (error) {
              ...
              {incomeList.map(income => (
                <tr key={income.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">{income.timeLapse}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">${income.amount.toFixed(2)}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
