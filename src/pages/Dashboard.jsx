			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div className="container mx-auto p-4">
					...
					<div className="bg-white rounded-lg shadow-md p-6 mb-6">
						<h2 className="text-xl font-bold mb-4">{t("advisor.title")}</h2>
						<p className="text-gray-600 mb-4">{t("advisor.subtitle")}</p>
						<Link
							to="/advisor"
							className="inline-flex items-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700"
						>
							<i className="feather-message-circle mr-2" />
							{t("advisor.viewHistory")}
						</Link>
					</div>
